...
module.exports = {
  ...
  One: props => FieldUtils.getFieldData(props, RelationalFields.One),
  Many: props => FieldUtils.getFieldData(props, RelationalFields.Many),
  ...
  OneField: RelationalFields.One,
  ManyField: RelationalFields.Many,
  FieldUtils,
};
